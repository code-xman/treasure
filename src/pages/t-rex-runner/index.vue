<template>
  <div class="fit column">
    <div id="offline" class="offline flex-1" @click="keydown32">
    ...
    <div class="q-pa-md full-width flex justify-between">
      <q-btn
        rounded
        color="teal"
        :label="btnType === 'start' ? '开始' : '跳'"
...
export default {
  ...
  mounted() {
    ...
    const runner_container =
      document.getElementsByClassName("runner-container");
    
    // 有runner_container则改变btnType，并触发一次keydown32
    if (!!runner_container.length) {
      this.btnType = "up";
      setTimeout(() => {
        this.keydown32();
      }, 0);
    ...
    if (!HTMLElement.prototype.pressKey) {
      // 自动按键
